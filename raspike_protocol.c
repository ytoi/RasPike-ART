...
static RPLockFuncs fgLockFuncs;
...
#if 0  
  if ( command ) {
    fgSensorCommand = command;
  } else {
    fgSensorCommand = malloc(sizeof(*command));
  }
#endif
